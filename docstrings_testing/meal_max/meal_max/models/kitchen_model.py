...
class Meal:
    ...
    Attributes:
        ...
        price (float): The price of the meal (positive value).
        difficulty (str): The preparation difficulty level ('LOW', 'MED', or 'HIGH').

    Raises:
        ValueError: If price is negative or difficulty level is invalid.
    """
    id: int
    meal: str
    cuisine: str
    ...
    def __post_init__(self):
        """Ensures Meal is initialized with valid price and difficulty"""
        if self.price < 0:
...
def create_meal(meal: str, cuisine: str, price: float, difficulty: str) -> None:
    """Creates a Meal object and adds it to the database
...
def delete_meal(meal_id: int) -> None:
    ...
    Args:
        meal_id (int): Unique identifier of the meal to delete.
...
def get_leaderboard(sort_by: str="wins") -> dict[str, Any]:
    """Gets a leaderboard of meals sorted by criteria.

    Args:
        sort_by (str): Sorting criteria. Defaults to 'wins'.
    
    Returns:
        leaderboard (List[Dict[str, Any]]): A list of dictionaries representing meals. 
        (Meal properties are represented by strings that map to their respective values).
...
def get_meal_by_id(meal_id: int) -> Meal:
    ...
    Returns:
        Meal: A Meal object with unique identifier meal_id.
...
def get_meal_by_name(meal_name: str) -> Meal:
    ...
    Returns:
        Meal: A Meal object with name meal_name.
...
def update_meal_stats(meal_id: int, result: str) -> None:
    """Updates the statistics for a meal.

    Args:
        meal_id (str): Unique identifier of the meal.
        result (str): The result of a battle ('win' or 'loss').

    Raises:
        ValueError: If the meal has been deleted or does not exist, or result is invalid.
        sqlite3.Error: For database errors.    
    """
    try:
        with get_db_connection() as conn:
